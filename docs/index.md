...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test-jun1](https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test-jun1)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test-jun1-gitops](https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test-jun1-gitops)

# **Usage**

To access the audio-to-text-gitlab-test-jun1 application that was deployed using the Software Template, complete the following instructions:
