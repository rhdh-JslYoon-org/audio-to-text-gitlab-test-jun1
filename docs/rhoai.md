...
3) Access the `workbench` named `audio-to-text-gitlab-test-jun1-notebook`.
...
5) In the terminal, run `cd audio-to-text-gitlab-test-jun1` to navigate to your sample app's directory.
